...
agent = QL(n_states=256, n_actions=4, alpha=0.01, gamma=0.99, epsilon=0.01)
...
for epoch in range(epochs):
    ...
    for episode in range(episodes):
        ...
        while True:
            ...
            agent.train(observation, action, reward, observation_, done)
            ...
            if done:
                if reward > 0:
                    ...
                    if first_win[epoch] == episodes:
                        ...
                        print(f"f: {episode}")
                    if perfect_win[epoch] == episodes and step == 6:
